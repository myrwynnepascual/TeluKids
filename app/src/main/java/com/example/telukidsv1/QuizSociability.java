...
public class QuizSociability extends AppCompatActivity {
    ...
    String quizData_Sociability[][] = {
            ...
            {"What is the right thing to do?", String.valueOf(R.drawable.sc2bg1), String.valueOf(R.raw.scq2_1), String.valueOf(R.drawable.sc2bg2), String.valueOf(R.raw.scq2_2), "Say 'Good morning, Grandpa and Grandma. Mano po.' ", "Ignore them and just play with her gadget", String.valueOf(R.raw.scq2c1), String.valueOf(R.raw.scq2c2) },
    ...
    public void assessmenttitle(){
        background_Sociability.setBackgroundResource(R.drawable.sociabilitytitle);
        Handler handler = new Handler();
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
