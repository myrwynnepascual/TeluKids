...
public class Achievements3to6Honesty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achievements3to6_honesty);

        ImageButton backbtnAchievements3to6 = findViewById(R.id.backbtnAchievements36Honesty);

        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline36Honesty);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty36Honesty);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect36Honesty);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability36Honesty);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion36Honesty);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility36Honesty);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove36Honesty);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience36Honesty);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood36Honesty);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors36Honesty);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting36Honesty);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition36Honesty);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction36Honesty);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes36Honesty);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline36Honesty);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty36Honesty);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect36Honesty);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability36Honesty);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion36Honesty);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility36Honesty);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove36Honesty);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience36Honesty);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood36Honesty);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors36Honesty);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting36Honesty);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition36Honesty);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction36Honesty);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes36Honesty);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline36Honesty);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty36Honesty);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect36Honesty);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability36Honesty);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion36Honesty);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility36Honesty);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove36Honesty);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience36Honesty);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood36Honesty);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors36Honesty);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting36Honesty);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition36Honesty);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction36Honesty);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes36Honesty);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline36Honesty);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty36Honesty);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect36Honesty);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability36Honesty);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion36Honesty);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility36Honesty);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove36Honesty);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience36Honesty);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood36Honesty);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors36Honesty);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting36Honesty);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition36Honesty);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction36Honesty);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes36Honesty);
