...
public class Achievements7to9Obedience extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achievements7to9_obedience);

        ImageButton backbtnAchievements3to6 = findViewById(R.id.backbtnAchievements79Obedience);

        MediaPlayer sfx = MediaPlayer.create(this, R.raw.btnsfx);

        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline79Obedience);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty79Obedience);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect79Obedience);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability79Obedience);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion79Obedience);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility79Obedience);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove79Obedience);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience79Obedience);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood79Obedience);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors79Obedience);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting79Obedience);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition79Obedience);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction79Obedience);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes79Obedience);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline79Obedience);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty79Obedience);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect79Obedience);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability79Obedience);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion79Obedience);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility79Obedience);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove79Obedience);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience79Obedience);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood79Obedience);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors79Obedience);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting79Obedience);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition79Obedience);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction79Obedience);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes79Obedience);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline79Obedience);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty79Obedience);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect79Obedience);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability79Obedience);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion79Obedience);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility79Obedience);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove79Obedience);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience79Obedience);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood79Obedience);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors79Obedience);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting79Obedience);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition79Obedience);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction79Obedience);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes79Obedience);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline79Obedience);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty79Obedience);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect79Obedience);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability79Obedience);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion79Obedience);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility79Obedience);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove79Obedience);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience79Obedience);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood79Obedience);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors79Obedience);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting79Obedience);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition79Obedience);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction79Obedience);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes79Obedience);
        ...
        backbtnAchievements3to6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                sfx.start();
                Intent proceed = new Intent(Achievements7to9Obedience.this, ObedienceLessonCongrats.class);
