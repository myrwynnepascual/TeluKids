...
public class Achievements7to9Responsibility2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achievements7to9_responsibility2);

        ImageButton backbtnAchievements3to6 = findViewById(R.id.backbtnAchievements79Responsibility2);

        MediaPlayer sfx = MediaPlayer.create(this, R.raw.btnsfx);

        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline79Responsibility2);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty79Responsibility2);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect79Responsibility2);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability79Responsibility2);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion79Responsibility2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility79Responsibility2);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove79Responsibility2);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience79Responsibility2);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood79Responsibility2);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors79Responsibility2);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting79Responsibility2);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition79Responsibility2);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction79Responsibility2);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes79Responsibility2);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline79Responsibility2);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty79Responsibility2);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect79Responsibility2);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability79Responsibility2);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion79Responsibility2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility79Responsibility2);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove79Responsibility2);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience79Responsibility2);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood79Responsibility2);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors79Responsibility2);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting79Responsibility2);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition79Responsibility2);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction79Responsibility2);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes79Responsibility2);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline79Responsibility2);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty79Responsibility2);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect79Responsibility2);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability79Responsibility2);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion79Responsibility2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility79Responsibility2);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove79Responsibility2);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience79Responsibility2);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood79Responsibility2);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors79Responsibility2);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting79Responsibility2);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition79Responsibility2);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction79Responsibility2);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes79Responsibility2);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline79Responsibility2);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty79Responsibility2);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect79Responsibility2);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability79Responsibility2);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion79Responsibility2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility79Responsibility2);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove79Responsibility2);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience79Responsibility2);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood79Responsibility2);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors79Responsibility2);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting79Responsibility2);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition79Responsibility2);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction79Responsibility2);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes79Responsibility2);
