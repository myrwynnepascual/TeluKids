...
public class Achievements3to6Counting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline36Counting);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty36Counting);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect36Counting);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability36Counting);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion36Counting);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility36Counting);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove36Counting);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience36Counting);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood36Counting);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors36Counting);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting36Counting);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition36Counting);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction36Counting);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes36Counting);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline36Counting);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty36Counting);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect36Counting);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability36Counting);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion36Counting);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility36Counting);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove36Counting);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience36Counting);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood36Counting);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors36Counting);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting36Counting);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition36Counting);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction36Counting);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes36Counting);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline36Counting);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty36Counting);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect36Counting);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability36Counting);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion36Counting);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility36Counting);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove36Counting);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience36Counting);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood36Counting);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors36Counting);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting36Counting);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition36Counting);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction36Counting);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes36Counting);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline36Counting);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty36Counting);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect36Counting);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability36Counting);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion36Counting);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility36Counting);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove36Counting);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience36Counting);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood36Counting);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors36Counting);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting36Counting);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition36Counting);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction36Counting);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes36Counting);
        ...
        backbtnAchievements3to6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent proceed = new Intent(Achievements3to6Counting.this, CountingLessonCongrats.class);
