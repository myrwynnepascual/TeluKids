...
public class Achievements3to6Sociability extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achievements3to6_sociability);

        ImageButton backbtnAchievements3to6 = findViewById(R.id.backbtnAchievements36Sociability);

        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline36Sociability);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty36Sociability);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect36Sociability);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability36Sociability);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion36Sociability);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility36Sociability);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove36Sociability);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience36Sociability);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood36Sociability);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors36Sociability);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting36Sociability);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition36Sociability);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction36Sociability);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes36Sociability);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline36Sociability);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty36Sociability);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect36Sociability);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability36Sociability);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion36Sociability);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility36Sociability);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove36Sociability);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience36Sociability);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood36Sociability);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors36Sociability);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting36Sociability);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition36Sociability);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction36Sociability);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes36Sociability);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline36Sociability);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty36Sociability);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect36Sociability);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability36Sociability);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion36Sociability);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility36Sociability);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove36Sociability);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience36Sociability);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood36Sociability);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors36Sociability);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting36Sociability);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition36Sociability);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction36Sociability);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes36Sociability);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline36Sociability);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty36Sociability);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect36Sociability);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability36Sociability);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion36Sociability);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility36Sociability);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove36Sociability);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience36Sociability);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood36Sociability);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors36Sociability);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting36Sociability);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition36Sociability);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction36Sociability);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes36Sociability);
