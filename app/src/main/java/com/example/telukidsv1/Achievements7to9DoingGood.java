...
public class Achievements7to9DoingGood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achievements7to9_doing_good);

        ImageButton backbtnAchievements3to6 = findViewById(R.id.backbtnAchievements79DoingGood);

        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline79DoingGood);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty79DoingGood);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect79DoingGood);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability79DoingGood);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion79DoingGood);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility79DoingGood);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove79DoingGood);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience79DoingGood);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood79DoingGood);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors79DoingGood);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting79DoingGood);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition79DoingGood);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction79DoingGood);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes79DoingGood);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline79DoingGood);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty79DoingGood);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect79DoingGood);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability79DoingGood);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion79DoingGood);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility79DoingGood);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove79DoingGood);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience79DoingGood);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood79DoingGood);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors79DoingGood);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting79DoingGood);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition79DoingGood);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction79DoingGood);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes79DoingGood);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline79DoingGood);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty79DoingGood);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect79DoingGood);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability79DoingGood);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion79DoingGood);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility79DoingGood);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove79DoingGood);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience79DoingGood);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood79DoingGood);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors79DoingGood);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting79DoingGood);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition79DoingGood);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction79DoingGood);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes79DoingGood);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline79DoingGood);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty79DoingGood);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect79DoingGood);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability79DoingGood);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion79DoingGood);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility79DoingGood);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove79DoingGood);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience79DoingGood);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood79DoingGood);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors79DoingGood);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting79DoingGood);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition79DoingGood);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction79DoingGood);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes79DoingGood);
