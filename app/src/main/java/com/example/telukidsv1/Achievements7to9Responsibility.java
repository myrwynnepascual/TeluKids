...
public class Achievements7to9Responsibility extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backbtnAchievements3to6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent proceed = new Intent(Achievements7to9Responsibility.this, ResponsibilityLessonCongrats.class);
