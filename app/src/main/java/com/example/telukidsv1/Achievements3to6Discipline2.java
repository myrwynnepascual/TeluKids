...
public class Achievements3to6Discipline2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline36Discipline2);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty36Discipline2);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect36Discipline2);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability36Discipline2);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion36Discipline2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility36Discipline2);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove36Discipline2);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience36Discipline2);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood36Discipline2);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors36Discipline2);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting36Discipline2);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition36Discipline2);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction36Discipline2);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes36Discipline2);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline36Discipline2);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty36Discipline2);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect36Discipline2);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability36Discipline2);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion36Discipline2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility36Discipline2);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove36Discipline2);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience36Discipline2);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood36Discipline2);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors36Discipline2);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting36Discipline2);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition36Discipline2);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction36Discipline2);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes36Discipline2);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline36Discipline2);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty36Discipline2);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect36Discipline2);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability36Discipline2);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion36Discipline2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility36Discipline2);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove36Discipline2);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience36Discipline2);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood36Discipline2);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors36Discipline2);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting36Discipline2);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition36Discipline2);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction36Discipline2);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes36Discipline2);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline36Discipline2);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty36Discipline2);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect36Discipline2);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability36Discipline2);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion36Discipline2);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility36Discipline2);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove36Discipline2);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience36Discipline2);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood36Discipline2);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors36Discipline2);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting36Discipline2);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition36Discipline2);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction36Discipline2);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes36Discipline2);
