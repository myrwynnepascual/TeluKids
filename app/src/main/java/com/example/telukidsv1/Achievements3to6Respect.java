...
public class Achievements3to6Respect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_achievements3to6_respect);

        ImageButton backbtnAchievements3to6 = findViewById(R.id.backbtnAchievements36Respect);

        //Trophies
        //GMRC 3-6
        ImageView imgAchievements_DisciplineTrophy = findViewById(R.id.trophydiscipline36Respect);
        ImageView imgAchievements_HonestyTrophy = findViewById(R.id.trophyhonesty36Respect);
        ImageView imgAchievements_RespectTrophy = findViewById(R.id.trophyrespect36Respect);
        ImageView imgAchievements_SociabilityTrophy = findViewById(R.id.trophysociability36Respect);
        ImageView imgAchievements_CompassionTrophy = findViewById(R.id.trophycompassion36Respect);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityTrophy = findViewById(R.id.trophyresponsibility36Respect);
        ImageView imgAchievements_LoveTrophy = findViewById(R.id.trophylove36Respect);
        ImageView imgAchievements_ObedienceTrophy = findViewById(R.id.trophyobedience36Respect);
        ImageView imgAchievements_DoingGoodTrophy = findViewById(R.id.trophydoinggood36Respect);

        //Basic Concepts
        ImageView imgAchievements_ColorsTrophy = findViewById(R.id.trophycolors36Respect);
        ImageView imgAchievements_CountingTrophy = findViewById(R.id.trophycounting36Respect);
        ImageView imgAchievements_AdditionTrophy = findViewById(R.id.trophyaddition36Respect);
        ImageView imgAchievements_SubtractionTrophy = findViewById(R.id.trophysubtraction36Respect);
        ImageView imgAchievements_ShapesTrophy = findViewById(R.id.trophyshapes36Respect);

        //Medals
        //GMRC 3-6
        ImageView imgAchievements_DisciplineMedal = findViewById(R.id.medaldiscipline36Respect);
        ImageView imgAchievements_HonestyMedal = findViewById(R.id.medalhonesty36Respect);
        ImageView imgAchievements_RespectMedal = findViewById(R.id.medalrespect36Respect);
        ImageView imgAchievements_SociabilityMedal = findViewById(R.id.medalsociability36Respect);
        ImageView imgAchievements_CompassionMedal = findViewById(R.id.medalcompassion36Respect);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityMedal = findViewById(R.id.medalresponsibility36Respect);
        ImageView imgAchievements_LoveMedal = findViewById(R.id.medallove36Respect);
        ImageView imgAchievements_ObedienceMedal = findViewById(R.id.medalobedience36Respect);
        ImageView imgAchievements_DoingGoodMedal = findViewById(R.id.medaldoinggood36Respect);

        //Basic Concepts
        ImageView imgAchievements_ColorsMedal = findViewById(R.id.medalcolors36Respect);
        ImageView imgAchievements_CountingMedal = findViewById(R.id.medalcounting36Respect);
        ImageView imgAchievements_AdditionMedal = findViewById(R.id.medaladdition36Respect);
        ImageView imgAchievements_SubtractionMedal = findViewById(R.id.medalsubtraction36Respect);
        ImageView imgAchievements_ShapesMedal = findViewById(R.id.medalshapes36Respect);


        //Badges
        //GMRC 3-6
        ImageView imgAchievements_DisciplineBadge = findViewById(R.id.badgediscipline36Respect);
        ImageView imgAchievements_HonestyBadge = findViewById(R.id.badgehonesty36Respect);
        ImageView imgAchievements_RespectBadge = findViewById(R.id.badgerespect36Respect);
        ImageView imgAchievements_SociabilityBadge = findViewById(R.id.badgesociability36Respect);
        ImageView imgAchievements_CompassionBadge = findViewById(R.id.badgecompassion36Respect);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityBadge = findViewById(R.id.badgeresponsibility36Respect);
        ImageView imgAchievements_LoveBadge = findViewById(R.id.badgelove36Respect);
        ImageView imgAchievements_ObedienceBadge = findViewById(R.id.badgeobedience36Respect);
        ImageView imgAchievements_DoingGoodBadge = findViewById(R.id.badgedoinggood36Respect);

        //Basic Concepts
        ImageView imgAchievements_ColorsBadge = findViewById(R.id.badgecolors36Respect);
        ImageView imgAchievements_CountingBadge = findViewById(R.id.badgecounting36Respect);
        ImageView imgAchievements_AdditionBadge = findViewById(R.id.badgeaddition36Respect);
        ImageView imgAchievements_SubtractionBadge = findViewById(R.id.badgesubtraction36Respect);
        ImageView imgAchievements_ShapesBadge = findViewById(R.id.badgeshapes36Respect);


        //Certificates
        //GMRC 3-6
        ImageView imgAchievements_DisciplineCertificate = findViewById(R.id.certificatediscipline36Respect);
        ImageView imgAchievements_HonestyCertificate = findViewById(R.id.certificatehonesty36Respect);
        ImageView imgAchievements_RespectCertificate = findViewById(R.id.certificaterespect36Respect);
        ImageView imgAchievements_SociabilityCertificate = findViewById(R.id.certificatesociability36Respect);
        ImageView imgAchievements_CompassionCertificate = findViewById(R.id.certificatecompassion36Respect);

        //GMRC 7-9
        ImageView imgAchievements_ResponsibilityCertificate = findViewById(R.id.certificateresponsibility36Respect);
        ImageView imgAchievements_LoveCertificate = findViewById(R.id.certificatelove36Respect);
        ImageView imgAchievements_ObedienceCertificate = findViewById(R.id.certificateobedience36Respect);
        ImageView imgAchievements_DoingGoodCertificate = findViewById(R.id.certificatedoinggood36Respect);

        //Basic Concepts
        ImageView imgAchievements_ColorsCertificate = findViewById(R.id.certificatecolors36Respect);
        ImageView imgAchievements_CountingCertificate = findViewById(R.id.certificatecounting36Respect);
        ImageView imgAchievements_AdditionCertificate = findViewById(R.id.certificateaddition36Respect);
        ImageView imgAchievements_SubtractionCertificate = findViewById(R.id.certificatesubtraction36Respect);
        ImageView imgAchievements_ShapesCertificate = findViewById(R.id.certificateshapes36Respect);
